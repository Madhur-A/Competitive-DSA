...
% As functional as I could make. TLE due to new list creation at each iteration
...
is_valid(I, J, Res) ->
    I >= 1 andalso J >= 1 andalso I < length(Res) + 1 andalso J < length(hd(Res)) + 1 andalso lists:nth(J, lists:nth(I, Res)) =:= -1.
